...
namespace GameCore.Specs.SpecFlow.Features
{
...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "PlayerCharacter", "In order to play the game\r\nAs a human player\r\nI want my character attributes to b" +
                    "e represented", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Elf race characters dont\' lose magical item power", Skip="Ignored")]
        [Xunit.TraitAttribute("FeatureTitle", "PlayerCharacter")]
        [Xunit.TraitAttribute("Description", "Elf race characters dont\' lose magical item power")]
        [Xunit.TraitAttribute("Category", "elf")]
        public virtual void ElfRaceCharactersDontLoseMagicalItemPower()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Elf race characters dont\' lose magical item power", new string[] {
                        "elf",
                        "ignore"});
#line 70
this.ScenarioSetup(scenarioInfo);
